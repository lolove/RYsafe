        ...
        <div class="row">
          <div class="col-auto col-md-1 col-lg-2 col-xl-3"></div>
            ...
            <div class="col-12 col-md-10 col-lg-8 col-xl-6" style="position: relative;">
              ...
              <form id="onCar">
                <button class="btn btn-orange-clicked rounded-0 px-4 btn-lg">已上車</button> 
              </form> 
            ...
            <div class="mt-3">
              ...
              <div class="row">
                ...
                <div class="col pl-0">
                  ...
                  <div class="pl-4">
                    <p class="m-0 far fa-check-circle card-icon-green littleIcon"></p><span>x8</span><br>
                    ...
                    <p class="m-0 fas fa-hand-sparkles card-icon-blue littleIcon"></p><span>x4</span><br>
                    <p class="m-0"></p><span>清潔比例：40%</span>
