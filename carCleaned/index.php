...
--> 
            <div id="cleaned">
              <button class="btn btn-orange rounded-0 px-4 btn-lg" data-toggle="modal" data-target="#driverModal">我已清潔</button> 
            </div>           
        ...
        <div class="modal-content rounded-0">
          ...
          <form action="../carCleaned">
            ...
            <div class="modal-footer pb-0 d-flex justify-content-center">            
              <button type="submit" class="btn btn-orange rounded-0 px-4 px-4">送出</button>
            </div>
            ...
            <div class="mt-3">
              ...
              <div class="row">
                ...
                <div class="col pl-0">
                  ...
                  <div class="pl-4">
                    <p class="m-0 far fa-check-circle card-icon-green littleIcon"></p><span>x7</span><br>
                    <p class="m-0 fas fa-exclamation-triangle card-icon-yellow littleIcon"></p><span>x1</span><br>
                    <p class="m-0 fas fa-head-side-mask card-icon-red littleIcon"></p><span>x1</span><br>
                    <p class="m-0 fas fa-hand-sparkles card-icon-blue littleIcon"></p><span>x5</span><br>
                    <p class="m-0"></p><span>清潔比例：55%</span>
